  ...
  return (
    <div className="stack">
      ...
      {selectedRefundId !== null && (
        ...
        >
          <section className="invoice-details-dialog" style={{ maxWidth: "780px", zIndex: 3201, position: "relative" }}>
            <div className="invoice-details-header">
              <div>
            ...
            {refundDetail && (
              <div>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", gap: "10px", marginTop: "16px" }}>
                  <button type="button" className="secondary" onClick={() => window.print()}>طباعة سند المرتجع 🖨️</button>
        ...
        <div className="print-hide" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid #e9e1d9", paddingTop: "14px" }}>
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            ...
            <button
              ...
              onClick={() => window.print()}
            >
              طباعة الآن (إلى طابعة الباركود) 🖨️
            </button>
          </div>
        </div>
      </section>
  ...
  return (
    <div className="online-page">
      ...
      {viewSlipOrder && (
        ...
        >
          <div className="online-slip-modal">
